...
## ReadTxT
    识别utf-8编码，对gbk等中文编码识别差
    下载地址：https://github.com/Arieldaytoy/ReadTXT
...
## TTS
   ...
   或者：https://github.com/samitooooo/MultiTTS
   其中，微软的xiaoxiao及yunxi语音表现较好。

# Docker
   推荐虚拟机安装istoreOS，有htreader，一键安装。
   https://github.com/hectorqin/reader

# 类似听歌的桌面歌词模式，Windows 10-11 x64设备
